        ...
        <div className="max-w-5xl max-auto flex md:items-center md:justify-center h-full p-6">
            <div>
                ...
                <p className="text-sm text-slate-600">
                    Enter the name of your course. <small>Note: You can edit the course name later as well.</small>
                </p>
                <Form {...form}>
                ...
                <FormField control={form.control} name="title" render={({field}) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                {/* Used the spread operator to copy the props from controllerRenderProps for field */}
